      ...
      {open && (
        <>
          <NumberField
            ...
            max={3.0}
            step={0.05}
            hint="p03 = p010·π_LPC (§3). NOT IN SOURCE numerically."
          />
          <NumberField
          ...
          <NumberField
            ...
            max={25}
            step={0.5}
            hint="p04 = p03·π_HPC (§3). NOT IN SOURCE numerically; chosen with π_f/π_LPC to reach a realistic overall pressure ratio."
          />
          <NumberField
