      ...
      {open && (
        <>
          <NumberField
            ...
            max={2.0}
            step={0.01}
            hint="p011 = p010·π_UDF (§2.2). NOT IN SOURCE numerically; kept modest since the fan is unducted and sized directly off the freestream, not the ducted core."
          />
          <NumberField
            ...
            max={0.98}
            step={0.01}
            hint="T011/T010 = 1 + (π_UDF^((γ−1)/γ)−1)/η_UDF (§2.2). NOT IN SOURCE numerically."
          />
        </>
      )}
    </fieldset>
