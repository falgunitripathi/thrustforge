#!/usr/bin/env python3
"""
Parity-harness helper: solve one TurbopropConfig scenario with the Python
reference implementation and print a flat JSON result to stdout.

Usage: python3 scripts/dump_turboprop_result.py '<json-encoded config overrides>'
"""
import json
import sys
